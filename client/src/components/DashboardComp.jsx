      ...
      <div className="flex-wrap flex gap-4 justify-center ">
        <div className="flex flex-col p-3 dark:bg-slate-600 md:w-72 w-full rounded-md shadow-md ">
          <div className="flex justify-between">
            <div className="">
              <h3 className="text-gray-500 text-md uppercase ">Kullanıcı sayısı</h3>
          ...
          <div className="flex gap-2 text-sm">
            ...
            <div className="text-gray-500">Son bir ay</div>
          </div>
        </div>
        <div className="flex flex-col p-3 dark:bg-slate-600 md:w-72 w-full rounded-md shadow-md ">
          <div className="flex justify-between">
            <div className="">
              <h3 className="text-gray-500 text-md uppercase ">Yorum sayısı</h3>
        ...
        <div className="flex flex-col p-3 dark:bg-slate-600 md:w-72 w-full rounded-md shadow-md ">
          <div className="flex justify-between">
            <div className="">
              <h3 className="text-gray-500 text-md uppercase ">Paylaşım sayısı</h3>
              ...
              <Table.Body key={comment._id} className="divide-y">
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  <Table.Cell className="w-96">
                    <p onClick={() => handleGoComment(comment)} className="line-clamp-2 cursor-pointer">{comment.content}</p>
                  </Table.Cell>
                  <Table.Cell>
            ...
            {posts && posts.map((post) => (
              <Table.Body key={post._id} className="divide-y">
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell className="w-96 line-clamp-1">
